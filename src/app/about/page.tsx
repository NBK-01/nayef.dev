...
const About = () => {
  return (
   <section className="max-w-screen-xl mx-auto flex pt-10 justify-between px-16">
        <div className="w-[65%] px-6 space-y-8">
